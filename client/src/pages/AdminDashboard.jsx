          ...
          <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden">
              <table class="min-w-full text-left text-sm font-light">
                <thead class="border-b font-medium border-white text-white">
                  <tr>
                ...
                <tbody>
                  <tr class="border-b dark:border-neutral-500">
                    <td class="whitespace-nowrap px-6 py-4 font-mediu">
                      <div className="flex items-center gap-2">
                        <h1 className="text-white text-2xl font-bold">1</h1>
                        <img
                          class="h-8 w-8 md rounded-full object-cover relative"
                    ...
                    <td class="whitespace-nowrap flex items-center px-6 py-4 text-white font-semibold">
                      <FaEthereum />
                      27,966.76
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-green-600 font-semibold">
                      +92.96
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-red-600 font-semibold">
                      -16.38
                    </td>
                    <td class="whitespace-nowrap px-6 flex items-center py-4 text-white font-semibold">
                      <FaEthereum />
                      12.99
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-white font-semibold">
                      5.9K
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-white font-semibold">
                      10K
                  ...
                  <tr class="border-b dark:border-neutral-500">
                    <td class="whitespace-nowrap px-6 py-4 font-mediu">
                      <div className="flex items-center gap-2">
                        ...
                        <img
                          class="h-8 w-8 md rounded-full object-fit relative"
