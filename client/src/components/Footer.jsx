        ...
        <footer className=" py-6 bg-opacity-50">
            ...
            <div className="container mx-auto flex flex-wrap justify-between">
                <div className="w-full md:w-1/2 lg:w-1/4 mb-8 md:mb-0">
                    <Link to="/" className="text-xl font-bold mb-2 text-white">B.A.T-squad</Link>
                    <h2 className="text-gray-600">Contact</h2>
                    <h3 className="text-gray-600">+21624797498</h3>
                    <h2 onClick={handleAdminClick} className="cursor-pointer text-gray-600">Admin</h2>
                    <address className="text-gray-600">
                        RBK sousse<br />
                        <a className="text-blue-400" href="mailto:">Email Us</a>
                    </address>
                </div>
