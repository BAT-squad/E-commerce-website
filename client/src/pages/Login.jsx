    ...
    <div>
      ...
      <div className="w-[90%] h-[550px] absolute top-[12%] left-[10%] iphone:left-[-150px]">
        <div className=" iphone:blockhidden">
          ...
          />
          <p className=" iphone:hidden absolute font-sans font-semibold text-xl text-center w-[30%] h-[39px] top-[420px] left-[5%] text-white">
          ...
          {view && (
            <div>
              ...
              <FaEyeSlash
                ...
                className=" absolute top-[78px] left-[88%] text-white"
              />
              <button
                onClick={handleLogin}
